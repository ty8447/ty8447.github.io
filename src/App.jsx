...
const App = () => {
  ...
  const handleIconClick = (href) => {
    if (window.innerWidth < 576) {
      if (href.startsWith('tel:')) {
        alert(`Phone Number: ${href.replace('tel:', '')}`);
      } else {
  ...
  const projectData = [
    ...
    },
    {
      ...
      summary: 'While in my second year at WPI, I wanted to add a little more ambiance to the apartment that had a bit more control than cheap LEDs, so I designed a UI to solve this.',
    ...
    },
    {
      ...
      summary: 'A while ago I needed to buy a part for another project but only a handful were made at a time and sold out within 40 seconds, so I tasked myself to build a program that would be able to purchase the part faster than that.',
    ...
    },
    {
      ...
      summary: 'For my anniversary I wanted to make something for my girlfriend that would be an easy and elegant way of communicating with each other and stumbled upon lamps that communicate with each other and challenged myself to break it into small pieces and complete the project with the set hard goals in under a 4 day timeline.',
    ...
    },
    {
      ...
      summary: 'Back in high school we were assigned to build a device from scratch and follow the engineering design process. After brainstorming for a while I decided to design and build a miniature CNC Machine.',
      link: '',
    ...
    },
    {
      ...
      summary: 'After building the electric Longboard I wanted to find different personal electric vehicles to ride and saw someone riding a Onewheel and wanted one, so instead of buying one from the company I decided to design and build my own.',
      link: '',
    ...
    },
    {
      ...
      summary: "At the end of 2022 I went with a team of students to Nantucket, MA where we were tasked with determining and proposing a plan to reduce the traffic congestion in the core downtown area of the island.",
    ...
    },
    {
      ...
      summary: 'This is one of my earliest projects where I was asked to build a retro "On Air" sign for a production that could be easily controlled and is one of the earliest projects where I used CAD to design and print the sign giving me a better understanding of various CAD techniques.',
      link: '',
        ...
        <div className="contact-container">
          ...
          <section id="contact" ref={contactRef}>
            ...
            <ul className="contact-items">
              <li>
                <svg fill="#132852" width="30px" height="30px" viewBox="0 0 32 32" onClick={() => handleIconClick('https://linkedin.com/cole-rabe')}>
                ...
                <a className="contact-text" style={{paddingLeft: 10}} href="https://linkedin.com/cole-rabe" target="_blank">
                {" "} linkedin.com/cole-rabe
                </a>
              </li>
              <li>
                <svg width="30px" height="30px" viewBox="0 0 24 24" fill="none" onClick={() => handleIconClick('mailto:colerabe@gmail.com')}>
                ...
                <a className="contact-text" style={{paddingLeft: 10}} href="mailto:colerabe@gmail.com">
                  colerabe@gmail.com
                </a>
              </li>
              <li>
                <svg fill="#132852" width="30px" height="30px" viewBox="0 0 24 24" onClick={() => handleIconClick('tel:+16177569014')}>
                ...
                <a className="contact-text" style={{paddingLeft: 10}} href="tel:+16177569014">
                  617-756-9014
                </a>
              </li>
            </ul>
